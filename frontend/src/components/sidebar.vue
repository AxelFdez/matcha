<template>
  ...
  >
      ...
      <ul class="space-y-2">
        ...
        <li>
          ...
          >
            <svg
              aria-hidden="true"
              class="size-6 flex-shrink-0 text-gray-400 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
    ...
    <div
      class="absolute bottom-0 left-0 z-20 hidden w-full justify-center space-x-4 border-r border-gray-200 bg-white p-4 lg:flex dark:border-gray-700 dark:bg-gray-800"
    >
      <a
        href="#"
